...
cc_var_dict <- tibble::tribble(
  ...
  "TP_mmhr",                "Total precipitation rate",     "mm/day",      "Precipitation",   0,       5,  "viridis",
  "Sf_mmhr",                "Snowfall rate",                "mm/day",      "Precipitation",   0,       2,  "viridis",
  "Rf_mmhr",                "Rainfall rate",                "mm/day",      "Precipitation",   0,       5,  "viridis",
  "Prain",                  "Precipitation (rain)",         "mm/period",   "Precipitation",   0,      500,  "viridis",
  "Psnow",                  "Precipitation (snow)",         "mm/period",   "Precipitation",   0,      500,  "viridis",
  "TP_mm",                  "Total precipitation",          "mm/period",   "Precipitation",   0,     500,  "viridis",
  "annual_precip_mm",       "Annual precipitation",         "mm/year",     "Precipitation",   0,    2000,  "viridis",
  "LWin",                   "Incoming longwave radiation",  "W m⁻²",       "Radiation",        100,    400,  "viridis",
  "SWin",                   "Incoming shortwave radiation", "W m⁻²",       "Radiation",        0,      350,  "viridis",
  ...
  "Total",                  "Total runoff",                 "mm/day",      "Hydrology",       0,      100,  "viridis",
  ...
  "WB",                     "Water balance",                "mm/day",      "Hydrology",      -50,      50,  "viridis",
  ...
  "PET_mm_hr_priestly",     "PET Priestley-Taylor",         "mm/day",      "Evaporation",     0,       0.5,  "viridis"
)
...
wrm_var_dict <- tibble::tribble(
  ...
  "Prain",  "Rainfall",                       "mm/day",  "Precipitation",   "viridis",
  "Psnow",  "Snowfall",                       "mm/day",  "Precipitation",   "viridis",
  "Total",  "Total Precipitation",            "mm/day",  "Precipitation",   "viridis",
  
  "SWE",    "Snow Water Equivalent",          "mm",      "Snow",            "viridis",
  "Msnow",  "Snow Melt",                      "mm/day",  "Snow",            "viridis",
  
  "Rech",   "Recharge",                       "mm/day",  "Hydrology",       "viridis",
