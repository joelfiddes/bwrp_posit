...
cc_var_dict <- tibble::tribble(
  ...
  "Prain",                  "Precipitation (rain)",         "mm/day",      "Precipitation",   0,      2,  "viridis",
  "Psnow",                  "Precipitation (snow)",         "mm/day",      "Precipitation",   0,      0.2,  "viridis",
  "TP_mm",                  "Total precipitation",          "mm/day",      "Precipitation",   0,     2,  "viridis",
  ...
  "Total",                  "Total runoff",                 "mm/day",      "Hydrology",       0,      1,  "viridis",
